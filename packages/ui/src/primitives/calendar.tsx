...
function Calendar({
  ...
  const localized = React.useMemo(
    () => calendarLocale(locale, props.timeZone),
  ...
  return (
    <DayPicker
      ...
      labels={{ ...(locale.configured ? localized.labels : {}), ...labels }}
      classNames={{
        ...
        today: cn(
          "rounded-md [&_button]:font-semibold [&_button]:underline [&_button]:underline-offset-4 data-[selected=true]:rounded-none",
